        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack spacing={4} w={'full'} maxW={'md'}>
            ...
            <FormControl id="email">
              ...
              <Input type="email" value={loginInput.email} name="email" placeholder='email@email.com' onChange={handleChange} />
            </FormControl>
            <FormControl id="password">
              <FormLabel>Password</FormLabel>
              <Input type="password" value={loginInput.password} name="password" placeholder='**********' onChange={handleChange} />
            </FormControl>
            <Stack spacing={6}>
              ...
              <Link color={'blue.500'} textAlign={"center"}>Forgot password?</Link>
