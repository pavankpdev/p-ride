...
const RideRequestCard: React.FC<IRideRequestCard> = (props) => {
    return <>
        <Box
            w={'100%'}
            p={'1rem'}
            ...
            <Flex w={'100%'}>
                <Flex flexDirection={'column'} w={'80%'} gap={'1rem'} >
                    <Flex flexDir={'column'} w={'100%'}>
                        <Text fontSize={'md'} w={'100%'} noOfLines={1}>{props.pickup}</Text>
                        <Text fontSize={'xs'} w={'100%'} fontWeight={800}><BsArrowDownCircle /></Text>
                        <Text fontSize={'md'} w={'100%'} noOfLines={1}>{props.drop}</Text>
                    </Flex>
                ...
                <Flex flexDir={'column'} alignItems={'center'} justifyContent={'center'} h={'100%'} w={'20%'}>
                    <Heading as={'h3'}>{props.distance}</Heading>
                    <Heading as={'h5'} size={'sm'}>Kms</Heading>
                </Flex>
            </Flex>
            <Button mt={'10px'} w={'full'} size={'sm'} colorScheme={'brand'}>Accept Ride</Button>
            <Button mt={'2px'} w={'full'} size={'sm'} variant={'ghost'} colorScheme={'brand'}>Pass</Button>
        </Box>
    </>
}
